...
void LoRaData(){
  ...
  Heltec.display->drawString(0 , 30 , "Received "+ String(totalDataReceived) + " bytes");
  Heltec.display->drawString(0, 41 , "Messages Received " + String(messagesReceived));
